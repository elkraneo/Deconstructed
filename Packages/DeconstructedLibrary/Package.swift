...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/Reality2713/SwiftUsd-binaries.git", exact: "0.3.125-macos-arm64.2"),
		.package(url: "https://github.com/Reality2713/SwiftUsdShell-binaries.git", exact: "0.3.125-macos-arm64.2"),
	],
	targets: [
